...
var read = function read(text) {
  ...
  var pattern = /.*!\[(.*)\]\((.*)\)/;
  var tokens = _marked2.default.lexer(content).map(function (t) {
  ...
  try {
    for (var _iterator = tokens[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      actions.push({
        ...
        img: img,
        text: t.text,
        options: (0, _assign2.default)({}, currentOptions, singleActionOptions)
      });
    }
  } catch (err) {
  ...
  _createClass(MarkdownPlayer, [{
    ...
    value: function _play() {
      ...
      if (window.speechSynthesis.paused) {
         ...
         */
        var lastSpeechRecord = this.speechRecord;
        setTimeout(function () {
          if (lastSpeechRecord === _this2.speechRecord) {
            _this2._next();
          }
        }, 1000);
      } else {
    ...
    key: '_rewriteUrl',
    value: function _rewriteUrl(url) {
